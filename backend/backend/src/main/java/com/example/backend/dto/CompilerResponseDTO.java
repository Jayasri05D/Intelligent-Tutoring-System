...
public class CompilerResponseDTO {
    ...
    public CompilerResponseDTO(String runtime_output, String runtime_error, boolean passed) {
        this.runtime_output = runtime_output;
        this.runtime_error = runtime_error;
        this.passed = passed;
    }

    public String getRuntime_output() { return runtime_output; }
    public String getRuntime_error() { return runtime_error; }
